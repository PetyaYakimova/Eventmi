    ...
    public partial class EventsTableAdded : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false, comment: "Id of the event")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false, comment: "Name of the event"),
                    Start = table.Column<DateTime>(type: "datetime2", nullable: false, comment: "Start date and time of the event"),
                    End = table.Column<DateTime>(type: "datetime2", nullable: false, comment: "End date and time of the event"),
